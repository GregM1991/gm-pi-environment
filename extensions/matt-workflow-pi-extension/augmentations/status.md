...
- For milestone review, treat milestones as human-facing delivery arcs, not AFK execution units and not parent/child hierarchy sources.
- Report PRD/container issues, child issues discovered from PRD child sections, ready-for-agent work, blockers, orphan milestone issues, and next human decisions.

...
type Phase = "intake" | "grill" | "wayfinder" | "spec" | "refactors" | "tickets" | "afk" | "review" | "closeout" | "auto";
...
const PHASES: Phase[] = ["intake", "grill", "wayfinder", "spec", "refactors", "tickets", "afk", "review", "closeout", "auto"];
